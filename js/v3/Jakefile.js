...
task('timeline', function () {
    var TIMELINE = './build/timeline/timeline.js';
    var TIMELINE_MIN = './build/timeline/timeline.min.js';
    var DIR = './build/timeline';
    jake.rmRf(DIR);
    jake.mkdirP(DIR);
    ...
    concat({
        dest: './build/timeline/timeline.css',
        src: [
    ...
    // copy examples
    jake.cpR('./src/examples/timeline', './build/timeline/examples/');
